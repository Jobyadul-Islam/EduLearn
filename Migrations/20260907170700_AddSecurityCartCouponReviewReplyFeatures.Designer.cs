...
namespace EduLearn.Migrations
{
    ...
    [Migration("20260907170700_AddSecurityCartCouponReviewReplyFeatures")]
    partial class AddSecurityCartCouponReviewReplyFeatures
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduLearn.Models.InstructorAccessRequest", b =>
                {
                    ...
                    b.Property<string>("DecidedByAdminId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("EduLearn.Models.InstructorAccessRequest", b =>
                {
                    b.HasOne("EduLearn.Models.ApplicationUser", "DecidedByAdmin")
                        .WithMany()
