...
namespace EduLearn.Migrations
{
    ...
    [Migration("20260830154035_AddRejectedApplicationArchive")]
    partial class AddRejectedApplicationArchive
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduLearn.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("EduLearn.Models.InstructorApplicationPin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("InstructorApplicationPins");
                });
            ...
            modelBuilder.Entity("EduLearn.Models.AssignmentReminder", b =>
                {
                    b.HasOne("EduLearn.Models.Assignment", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EduLearn.Models.Course", b =>
                {
                    ...
                    b.HasOne("EduLearn.Models.ApplicationUser", "Instructor")
                        .WithMany()
            ...
            modelBuilder.Entity("EduLearn.Models.InstructorApplicationPin", b =>
                {
                    b.HasOne("EduLearn.Models.ApplicationUser", "GeneratedByAdmin")
                        .WithMany()
            ...
            modelBuilder.Entity("EduLearn.Models.QuizOption", b =>
                {
                    b.HasOne("EduLearn.Models.QuizQuestion", "QuizQuestion")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("EduLearn.Models.QuizQuestion", b =>
                {
                    b.HasOne("EduLearn.Models.Quiz", "Quiz")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("EduLearn.Models.QuizResult", b =>
                {
                    ...
                    b.HasOne("EduLearn.Models.ApplicationUser", "Student")
                        .WithMany()
                        .HasForeignKey("StudentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
